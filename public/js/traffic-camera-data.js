        ...
        sources: [
            {
                ...
                embedUrl: "https://player.camerasrj.com.br/camera/1014/",
                suportaIframe: true,
                sourceProvider: "CamerasRJ",
                requiresCodec: "H265",
                protocol: "WebRTC/WHEP",
                fallbackSources: ["RJ_ZET_UFRJ_03", "RJ_MAPA_RIO_01"],
                healthStatus: "online",
            ...
            },
            {
                ...
                embedUrl: "https://player.camerasrj.com.br/camera/1010/",
                suportaIframe: true,
                sourceProvider: "CamerasRJ",
                requiresCodec: "H265",
                protocol: "WebRTC/WHEP",
                fallbackSources: ["RJ_ZET_UFRJ_01", "RJ_MAPA_RIO_01"],
                healthStatus: "online",
                lastValidation: new Date().toISOString(),
                prioridade: 2,
            ...
            },
            {
                ...
                regional: "RJ",
                cidade: "Rio de Janeiro",
                bairro: "Centro / Corredores Viários",
                referencia: "UFRJ ZET - Rio de Janeiro",
                nome: "UFRJ ZET - Centro & Corredores Viários",
                tipoFonte: "stream",
                ...
                lastValidation: new Date().toISOString(),
                prioridade: 3,
                observacao: "Transmissão ao vivo de corredores viários do Rio"
            },
            {
                id: "RJ_ZET_UFRJ_02",
                regional: "RJ",
                cidade: "Rio de Janeiro",
                bairro: "Ponte Rio-Niterói / Baía",
                referencia: "UFRJ ZET - Ponte Rio-Niterói",
                nome: "UFRJ ZET - Ponte Rio-Niterói Ao Vivo",
                tipoFonte: "stream",
                url: "https://www02.smt.ufrj.br/~tvdigital/zet/page_02.html",
                embedUrl: "https://www02.smt.ufrj.br/~tvdigital/zet/page_02.html",
                suportaIframe: true,
                healthStatus: "online",
                lastValidation: new Date().toISOString(),
                prioridade: 4,
                observacao: "Monitoramento contínuo da Ponte Rio-Niterói e acessos"
            },
            {
                id: "RJ_ZET_UFRJ_01",
                regional: "RJ",
                cidade: "Rio de Janeiro",
                bairro: "Ilha do Fundão / Linha Vermelha",
                referencia: "UFRJ ZET - Fundão / Linha Vermelha",
                nome: "UFRJ ZET - Ilha do Fundão / Linha Vermelha",
                tipoFonte: "stream",
                url: "https://www02.smt.ufrj.br/~tvdigital/zet/page_01.html",
                embedUrl: "https://www02.smt.ufrj.br/~tvdigital/zet/page_01.html",
                suportaIframe: true,
                healthStatus: "online",
                lastValidation: new Date().toISOString(),
                prioridade: 5,
                observacao: "Fluxo viário Linha Vermelha e Cidade Universitária"
            },
            {
                id: "RJ_MAPA_RIO_01",
                regional: "RJ",
                ...
                lastValidation: new Date().toISOString(),
                prioridade: 6,
                observacao: "Painel georreferenciado com todas as câmeras públicas do Rio"
            },
            {
                ...
                embedUrl: "https://player.camerasrj.com.br/camera/1301/",
                suportaIframe: true,
                sourceProvider: "CamerasRJ",
                requiresCodec: "H265",
                protocol: "WebRTC/WHEP",
